...
## 國外求職履歷撰寫
​
紀錄從剛出社會慘不忍睹的履歷一路到收到大公司面試邀約的履歷，利用這段期間摸索、學習、請教人的經驗後續幫多人潤飾履歷，甚至讓求職者從沒有面試機會到收到面試邀約，最後還拿到 offer。
...
如何維護你的 Github 頁面和整理作品集；我自己是另外還寫了網站式履歷，在面試過程中還有一邊寫 blog，意外的很多面試官看，還特別喜歡互動式網站式履歷，也很欣賞我在 blog 上堅持分享技術和經驗的態度與精神。
...
* [國外找工作 :: 應徵工作的前置作業 - 工作生活資訊查詢、設定工作條件、職缺平台註冊和撰寫 cover letter](https://yschen25.blogspot.com/2021/01/oversea-find-a-job.html)

<br/>


增加被邀請參與面試的機率，包括自行投遞職缺、內推、主動寄信給公司等方式介紹；列舉各式各樣我遇過的 head hunter && Recruiter 類型，那要如何和對方打交道；若人在台灣怎麼安排和國外公司的面試時間​。

* [國外找工作 :: 投遞履歷、和 head hunter && Recruiter 打交道、如何約定面試時間](https://yschen25.blogspot.com/2022/10/oversea-apply-a-job.html)
...
* [國外找工作 :: Coding interview 就是刷好刷滿刷爆 LeetCode 就會上?](https://yschen25.blogspot.com/2022/02/coding-interview.html)
...
這是一篇 PTE 勸世文，身邊不少朋友也深受其害。當然這有可能只是我個人觀點，只是想分享自己關於考 PTE 的經驗有多糟，光是考試時間不會同時開始就很扯，還有評分標準、女生魔咒等等。但不代表考 PTE 完全沒有優點，可以自行評估下。

* [想考 PTE 前先稍微花點時間看看這篇文章吧，台幣三萬五的經驗](https://yschen25.blogspot.com/2022/09/PTE-sucks.html)
...
* [學習筆記 :: 用 JavaScript 刷 LeetCode 01 - Hash Map (雜湊表) 講解，附題目連結整理表下載](https://yschen25.blogspot.com/2022/03/leetcode-01-hash-map.html)​
* [學習筆記 :: 用 JavaScript 刷 LeetCode 02 - Linked List (鍊表) 講解，附題目連結整理表下載](https://yschen25.blogspot.com/2022/04/javascript-leetcode-02-linked-list.html)​
* [學習筆記 :: 用 JavaScript 刷 LeetCode 03 - Recursion (遞迴) 講解，附題目連結整理表下載](https://yschen25.blogspot.com/2022/04/javascript-leetcode-03-recursion.html)​
* [學習筆記 :: 用 JavaScript 刷 LeetCode 04 - Stack & Queue (堆疊 & 佇列) 講解，附題目連結整理表下載](https://yschen25.blogspot.com/2022/04/javascript-leetcode-04-stack-queue.html)​
* [學習筆記 :: 用 JavaScript 刷 LeetCode 05 - Tree & Binary tree & Binary search tree (樹 & 二元樹 & 二元搜尋樹) 講解，附題目連結整理表下載](https://yschen25.blogspot.com/2022/04/javascript-leetcode-05-tree-binary-tree.html)
